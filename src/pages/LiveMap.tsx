  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] md:h-full flex relative">
      ...
      <div className="flex-1 relative min-w-0">
        ...
        <MapContainer center={mapCenter} zoom={1} className="h-full w-full bg-background [&_.leaflet-pane]:!z-[1] [&_.leaflet-control-container]:!z-[2]" crs={L.CRS.Simple} minZoom={-1} maxZoom={5} zoomControl={true} attributionControl={false}>
